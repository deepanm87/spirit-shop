...
import { PotionHeaderType, PotionInfoCardType, PotionStatsType } from "@/types/types"
...
export const PotionHeader = ({
    ...
    return (
        <div className={cn('flex items-center', size === "medium" ? 'mb-6' : 'mb-2')}>
            <div className={cn('rounded-full bg-secondary/50 flex items-center justify-center',
            ...
            <div>
                <h3 className={cn('font-bold', size === 'medium' ? 'text-xl' : 'text-base')}>
                    {name}
                </h3>
